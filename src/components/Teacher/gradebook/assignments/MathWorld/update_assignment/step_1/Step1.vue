    ...
    <div class="main-content">
        ...
        <v-card-actions>
            <div class="content-actions">
                <v-btn large width="15%" outlined @click="dialog.status = true">
                    Cancel
                </v-btn>
                <v-btn
                    large
...
import YesOrNo from "@/components/Teacher/main/dialogs/YesNoOption.vue";
...
export default {
    ...
    data() {
        return {
            ...
            dialog: {
                ...
                message:
                    "Do you want to cancel all the operations? Changes you made so far will not be saved.",
            },
        };
    },
    ...
    methods: {
        ...
        getCurrentData() {
            ...
            this.current_data.title = assignment.title;
            this.current_data.description = assignment.description;

            this.new_data.title = assignment.title;
            this.new_data.description = assignment.description;
        },

        noChanges() {
            if (
                JSON.stringify(this.current_data) ==
                JSON.stringify(this.new_data)
            ) {
                return true;
            } else {
                return false;
        ...
        submit() {
            return MW_UpdateAssignment.prototype.submit_Step1(
                this.$route.params.assignment_code,
                this.new_data.title,
    ...
    computed: {
        ...
        titleErrors() {
            ...
            !this.$v.new_data.title.required &&
                errors.push("Title is required");
            !this.$v.new_data.title.maxLength &&
        ...
        descriptionErrors() {
            ...
            !this.$v.new_data.description.required &&
                errors.push("Description is required");
            !this.$v.new_data.description.maxLength &&
                errors.push("Description must be at most 25 characters long");
            return errors;
        },
    },

    ...
    <div class="main-content">
        ...
        <v-card-actions>
            <div class="content-actions">
                ...
                <v-btn large width="15%" color="primary" @click="clickUpdate()">
                    Update
                </v-btn>
            </div>
        </v-card-actions>
...
export default {
    data() {
        return {
            new_assignment: MW_UpdateAssignment.prototype.getNewAssignment(),
        };
    },

    methods: {
        clickUpdate() {
            if (this.submit()) this.$emit("clickUpdate");
        },

        submit() {
            return MW_UpdateAssignment.prototype.submit_Step4(
                this.new_assignment
            );
        },
    },

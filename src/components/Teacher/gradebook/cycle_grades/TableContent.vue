<template>
    <div class="content">
        ...
        <div class="tab-table">
            ...
            <div
                :class="{
                    table_center: total_cycles <= 4,
                    table_center_hover: total_cycles > 4,
                }"
            >
                <table>
                    <thead>
                        <tr>
                            <td v-for="(item, index) in cycles" :key="index">
                                {{ item }}
                            </td>
                        </tr>
                    </thead>
...
export default {
    ...
    data() {
        return {
            ...
            headers: CycleGradesService.prototype.getTableHeaders(),

            cycles: CycleGradesService.prototype.getAllCycles(),

            students: CycleGradesService.prototype.getAllStudents(),
    ...
    watch: {
        search_student() {
            if (this.search_student != "") {
                this.item_index =
                    CycleGradesService.prototype.searchStudentByCode(
                        this.search_student
                    );
            }
        },
    ...
    created() {
        this.total_cycles = this.cycles.length;
    },
};
</script>

                    ...
                    <v-row dense>
                        <v-col cols="12">
                            <v-alert
                                ...
                                type="error"
                                color="deep-orange"
                                v-if="checkTotalGradeWeights > 100"
                            >
                                <span>
                                    Total grade weights must not exceed to 100%.
                                </span>
                            </v-alert>
                        </v-col>
                        <v-col cols="12" sm="6">
...
export default {
    ...
    computed: {
        ...
        testsErrors() {
            const errors = [];
            if (
                parseInt(this.new_item.tests) < 0 ||
            ...
            !this.$v.new_item.tests.required &&
                errors.push("Tests is required.");
            return errors;
        },
        ...
        quizzesErrors() {
            const errors = [];
            if (
                parseInt(this.new_item.quizzes) < 0 ||
            ...
            !this.$v.new_item.quizzes.required &&
                errors.push("Quizzes is required.");
            return errors;
        },
        ...
        homeworksErrors() {
            const errors = [];
            if (
                parseInt(this.new_item.homeworks) < 0 ||
            ...
            !this.$v.new_item.homeworks.required &&
                errors.push("Homeworks is required.");
            return errors;
        },
        ...
        projectsErrors() {
            const errors = [];
            if (
                parseInt(this.new_item.projects) < 0 ||
            ...
            !this.$v.new_item.projects.required &&
        ...
        finalsErrors() {
            const errors = [];
            if (
                parseInt(this.new_item.finals) < 0 ||
            ...
            !this.$v.new_item.finals.required &&
                errors.push("Finals is required.");
            return errors;
        },
    },
};
